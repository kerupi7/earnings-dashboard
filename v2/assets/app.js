...
const SECTOR_OVERVIEW = {
 "semi": {
  "market": "半導体市場は <strong>急成長中</strong>（AIの普及がけん引し、年8〜30%の成長）",
  "trends": [
   "データセンターのAI向け半導体（GPU=画像やAI計算が得意なチップ、ASIC=特定用途の専用チップ）の需要が爆発的に拡大",
   "回路をより小さく刻む『微細化』の競争（3nm→2nm→1.4nm）。製造大手TSMCの動向が業界を左右",
   "中国向け輸出規制や国際情勢（地政学リスク）が業界全体に影響"
  ],
  "note": "AI需要には好不調の波があり、製造を請け負うファウンドリ（受託製造工場）の動きにも注意",
  "status": "growing"
 },
 "software": {
  "market": "クラウド/SaaS（ネット経由で使うソフト）市場は <strong>安定成長</strong>（年15〜20%）",
  "trends": [
   "生成AIによる業務効率化や、AIエージェント（自動で作業するAI）の普及",
   "定額で使い続けるサブスク型ビジネスへの移行が加速",
   "サイバーセキュリティ（情報防衛）の需要は構造的に拡大"
  ],
  "note": "ARR（年間の定期収入）の成長率と、顧客の解約率（Churn）が重要指標",
  "status": "growing"
 },
 "hardware": {
  "market": "ハードウェア市場は <strong>成熟期</strong>（高価格帯へのシフト）",
  "trends": [
   "高性能化やAI機能の内蔵で差別化",
   "台数より単価を重視し、プレミアム（高価格）端末に集中",
   "定額のサービス収入が利益の柱に"
  ],
  "note": "出荷台数より、単価×サービス収入の組み合わせを見る",
  "status": "stable"
 },
 "internet": {
  "market": "ネット広告市場は <strong>成熟期</strong>（生成AI検索で構造変化）",
  "trends": [
   "生成AIによる検索の台頭で、広告の稼ぎ方が変化",
   "動画・ショート動画が主戦場に",
   "広告を狙った相手に届ける技術（ターゲティング）の精度が向上"
  ],
  "note": "広告単価・ユーザーの利用時間・新領域（クラウド/AI）を見る",
  "status": "stable"
 },
 "retail": {
  "market": "ネット通販・小売は <strong>ネットシフトが継続</strong>（実店舗は勝ち負けが鮮明に）",
  "trends": [
   "ネットと実店舗の融合（オムニチャネル）",
   "AIや物流の効率化による配送スピード競争",
   "自社開発の独自商品（プライベートブランド）や定額サービスを強化"
  ],
  "note": "客単価（1人あたりの購入額）・客数・粗利率の3つに分けて見る",
  "status": "growing"
 },
 "media": {
  "market": "メディア・通信は <strong>配信競争が激化</strong>",
  "trends": [
   "動画配信（ストリーミング）の競争が激化",
   "広告付き定額プランへの転換、ライブスポーツを重視",
   "5G（高速通信）やIoT（あらゆる機器のネット接続）で通信需要が拡大"
  ],
  "note": "加入者数・解約率・コンテンツ投資の効率を見る",
  "status": "stable"
 },
 "consumer": {
  "market": "消費財・飲食は <strong>安定成長</strong>（物価高への対応と健康志向）",
  "trends": [
   "高価格化と健康志向で二極化",
   "海外の新興国市場を開拓",
   "コスト管理と、値上げでコスト増を吸収する力"
  ],
  "note": "値上げで利益を守る力（価格転嫁力＝プライシングパワー）が利益率の鍵",
  "status": "stable"
 },
 "healthcare": {
  "market": "ヘルスケア市場は <strong>構造的に成長</strong>（高齢化が追い風）",
  "trends": [
   "バイオ医薬や遺伝子治療の技術革新",
   "AIによる新薬開発（創薬）や診断機器の進化",
   "主力薬の特許切れ（パテントクリフ）への対応と買収戦略"
  ],
  "note": "開発中の新薬候補群（パイプライン）の充実度と、FDA（米国の医薬品認可当局）の承認動向に注目",
  "status": "growing"
 },
 "auto": {
  "market": "EV（電気自動車）市場は <strong>成長続くも競争激化</strong>",
  "trends": [
   "EV普及の拡大と電池価格の低下",
   "自動運転やソフトウェアでの差別化",
   "中国EVメーカーとの価格競争"
  ],
  "note": "生産台数・平均販売価格（ASP）・利益率を見る",
  "status": "growing"
 },
 "utilities": {
  "market": "電力・公益は <strong>AI需要で再加速</strong>",
  "trends": [
   "AIデータセンター向けの電力需要が急増",
   "再生可能エネルギーへの移行",
   "送電網のスマート化、原子力の見直し"
  ],
  "note": "配当利回り（株価に対する年間配当の割合）・規制環境・天候の影響に注意",
  "status": "growing"
 },
 "industrials": {
  "market": "産業・物流は <strong>景気連動</strong>（経済の成長と連動）",
  "trends": [
   "物流の効率化・自動化",
   "定額サービスによる収益化",
   "ESG（環境・社会・企業統治への配慮）や脱炭素への対応"
  ],
  "note": "景気の波との連動度合いと、受注残（Backlog＝未消化の注文）を見る",
  "status": "stable"
 },
 "energy": {
  "market": "エネルギーは <strong>原油価格に連動</strong>",
  "trends": [
   "脱炭素の圧力とエネルギー転換",
   "シェール（岩盤から採る石油・ガス）開発の効率化",
   "中東情勢など地政学リスク"
  ],
  "note": "原油価格の動向と生産コストを見る",
  "status": "stable"
 }
};
